...
def init_task_specified_params(args):    
    ...
    args.particleNetSettings =  {
            ...
            "input_features": args.num_channels,
            "output_classes": args.num_classes,
        }
    # args.net = LorentzNet(n_scalar=1, n_hidden=72, n_class = args.num_classes, n_layers = 1)
    args.net = ParticleNet(args.particleNetSettings, args.device)
    ...
    args.criterion = nn.CrossEntropyLoss(reduction='none') 
